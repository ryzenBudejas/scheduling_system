!function (i) {
    "use strict"; function t() {
        ...
        t.prototype.initMenu = function () {
            var t, e = this; this._reset(), i(document).on("click", ".button-menu-mobile", function (t) {
                ...
                i(".side-nav").length && (t = i(".side-nav li .collapse"), i(".side-nav li [data-bs-toggle='collapse']").on("click", function (t) { return !1 }), t.on({ "show.bs.collapse": function (t) { var e = i(t.target).parents(".collapse.show"); i(".side-nav .collapse.show").not(t.target).not(e).collapse("hide") } }), i(".side-nav a").each(function () { var t, e, a, o = window.location.href.split(/[?#]/)[0]; this.href == o && (i(this).addClass("active"), i(this).parent().addClass("menuitem-active"), i(this).parent().parent().parent().addClass("show"), i(this).parent().parent().parent().parent().addClass("menuitem-active"), "sidebar-menu" !== (t = i(this).parent().parent().parent().parent().parent().parent()).attr("id") && t.addClass("show"), i(this).parent().parent().parent().parent().parent().parent().parent().addClass("menuitem-active"), "wrapper" !== (e = i(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr("id") && e.addClass("show"), (a = i(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || a.addClass("menuitem-active")) })); var a = document.querySelectorAll("ul.navbar-nav .dropdown .dropdown-toggle"), o = !1; a.forEach(function (a) { a.addEventListener("click", function (t) { var e; a.parentElement.classList.contains("nav-item") || (o = !0, e = a.parentElement.parentElement.parentElement.querySelector(".nav-link"), bootstrap.Dropdown.getInstance(e).show(), a.ariaExpanded ? bootstrap.Dropdown.getInstance(a).hide() : bootstrap.Dropdown.getInstance(e).show(), o = !0) }), a.addEventListener("hide.bs.dropdown", function (t) { o && (t.preventDefault(), t.stopPropagation(), o = !1) }), a.addEventListener("show.bs.dropdown", function (t) { o || a.parentElement.classList.contains("nav-item") || (t.preventDefault(), t.stopPropagation(), o = !0) }) })
        }, t.prototype.init = function () { this.initMenu() }, i.LeftSidebar = new t, i.LeftSidebar.Constructor = t
}(window.jQuery), function (a) {
    "use strict"; function t() { this.$body = a("body"), this.$window = a(window) }
    t.prototype.initMenu = function () {
        a(".topnav-menu").length && (a(".topnav-menu li a").each(function () {
            var t = window.location.href.split(/[?#]/)[0]; this.href == t && (a(this).addClass("active"), a(this).parent().parent().addClass("active"),
    ...
    }, t.prototype.toggleRightSideBar = function () { this.body.toggleClass("end-bar-enabled"), this._selectOptionsFromConfig() },
        t.prototype.init = function () {
            var e = this; a(document).on("click", ".end-bar-toggle", function () { e.toggleRightSideBar() }), a(document).on("click", "body", function (t) { 0 < a(t.target).closest(".end-bar-toggle, .end-bar").length || 0 < a(t.target).closest(".leftside-menu, .side-nav").length || a(t.target).hasClass("button-menu-mobile") || 0 < a(t.target).closest(".button-menu-mobile").length || (a("body").removeClass("end-bar-enabled"), a("body").removeClass("sidebar-enable")) }), a("input[type=checkbox][name=width]").change(function () { switch (a(this).val()) { case "fluid": a.App.activateFluid(); break; case "boxed": a.App.activateBoxed() }e._selectOptionsFromConfig() }), a("input[type=checkbox][name=theme]").change(function () { switch (a(this).val()) { case "default": a.App.activateDefaultSidebarTheme(); break; case "light": a.App.activateLightSidebarTheme(); break; case "dark": a.App.activateDarkSidebarTheme() }e._selectOptionsFromConfig() }), a("input[type=checkbox][name=compact]").change(function () { switch (a(this).val()) { case "fixed": a.App.deactivateCondensedSidebar(), a.App.deactivateScrollableSidebar(); break; case "scrollable": a.App.activateScrollableSidebar(); break; case "condensed": a.App.activateCondensedSidebar() }e._selectOptionsFromConfig() }), a("input[type=checkbox][name=color-scheme-mode]").change(function () { switch (a(this).val()) { case "light": a.App.deactivateDarkMode(), a("#default-check").prop("checked", !0), a("input[type=checkbox][name=theme]").prop("disabled", !1); break; case "dark": a.App.activateDarkMode(), a("#dark-check").prop("checked", !0) }e._selectOptionsFromConfig() }), a("#resetBtn").on("click", function (t) { t.preventDefault(), a.App.resetLayout(function () { e._selectOptionsFromConfig() }) })
        }, a.RightBar = new t, a.RightBar.Constructor = t
}(window.jQuery), function (a) {
    "use strict"; function t() {
        this.body = a("body"),
            this.window = a(window),
            this._config = {}, this.defaultSelectedStyle = null
    }
    var e = "default", o = "light", i = "dark",
        n = { sideBarTheme: e, isBoxed: !1, isCondensed: !1, isScrollable: !1, isDarkModeEnabled: !1 }; t.prototype._saveConfig = function (t) { a.extend(this._config, t) },
            t.prototype._getStoredConfig = function () {
                var t = this.body.data("layoutConfig"), e = n; return t && (e.sideBarTheme = t.leftSideBarTheme, e.isBoxed = t.layoutBoxed, e.isCondensed = t.leftSidebarCondensed, e.isScrollable = t.leftSidebarScrollable,
                    e.isDarkModeEnabled = t.darkMode), e
            },
            t.prototype._applyConfig = function () {
                var t = this; switch (this._config = this._getStoredConfig(), a.LeftSidebar.init(), t._config.sideBarTheme) { case i: t.activateDarkSidebarTheme(); break; case o: t.activateLightSidebarTheme() }
    ...
    t.prototype.initSelect2 = function () { n('[data-toggle="select2"]').select2() },
        t.prototype.initMask = function () {
            n('[data-toggle="input-mask"]').each(function (t, e) { var a = n(e).data("maskFormat"), o = n(e).data("reverse"); null != o ? n(e).mask(a, { reverse: o }) : n(e).mask(a) })
        },
        t.prototype.initDateRange = function () {
            var o = { cancelClass: "btn-light", applyButtonClasses: "btn-success" };
            n('[data-toggle="date-picker"]').each(function (t, e) { var a = n.extend({}, o, n(e).data()); n(e).daterangepicker(a) });
            var i = {
    ...
    function (a) {
        ...
        t.prototype.activateDefaultSidebarTheme = function () { a.LayoutThemeApp.activateDefaultSidebarTheme() },
            t.prototype.activateLightSidebarTheme = function () { a.LayoutThemeApp.activateLightSidebarTheme() },
            t.prototype.activateDarkSidebarTheme = function () { a.LayoutThemeApp.activateDarkSidebarTheme() },
            t.prototype.activateCondensedSidebar = function () { a.LayoutThemeApp.activateCondensedSidebar() },
            t.prototype.deactivateCondensedSidebar = function () { a.LayoutThemeApp.deactivateCondensedSidebar() },
            t.prototype.activateScrollableSidebar = function () { a.LayoutThemeApp.activateScrollableSidebar() },
            t.prototype.deactivateScrollableSidebar = function () { a.LayoutThemeApp.deactivateScrollableSidebar() },
            t.prototype.activateBoxed = function () { a.LayoutThemeApp.activateBoxed() },
            t.prototype.activateFluid = function () { a.LayoutThemeApp.activateFluid() },
            t.prototype.activateDarkMode = function () { a.LayoutThemeApp.activateDarkMode() },
            t.prototype.deactivateDarkMode = function () { a.LayoutThemeApp.deactivateDarkMode() },
            t.prototype.clearSavedConfig = function () { a.LayoutThemeApp.clearSavedConfig() },
            t.prototype.getLayoutConfig = function () { return a.LayoutThemeApp.getConfig() },
            t.prototype.resetLayout = function (t) { a.LayoutThemeApp.reset(t) },
            t.prototype.init = function () {
                a.LayoutThemeApp.init(), setTimeout(function () { document.body.classList.remove("loading") }, 400),
                    a.RightBar.init(); var t = this.$body.data("layoutConfig"); window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnStart") && t.showRightSidebarOnStart && (sessionStorage.getItem("_HYPER_VISITED_") || (a.RightBar.toggleRightSideBar(), sessionStorage.setItem("_HYPER_VISITED_", !0))), a.Portlet.init(), a.AdvanceFormApp.init(), a.Components.init(), a(window).on("load", function () { a("#status").fadeOut(), a("#preloader").delay(350).fadeOut("slow") });[].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]')).map(function (t) { return new bootstrap.Popover(t) }); document.querySelectorAll('[data-bs-toggle="tooltip"]').forEach(function (e) { e.addEventListener("mouseover", function (t) { new bootstrap.Tooltip(e).show() }) });[].slice.call(document.querySelectorAll(".offcanvas")).map(function (t) { return new bootstrap.Offcanvas(t) }); var e = document.getElementById("toastPlacement"); e && document.getElementById("selectToastPlacement").addEventListener("change", function () { e.dataset.originalClass || (e.dataset.originalClass = e.className), e.className = e.dataset.originalClass + " " + this.value });[].slice.call(document.querySelectorAll(".toast")).map(function (t) { return new bootstrap.Toast(t) }); document.getElementById("light-style").href.includes("rtl.min.css") && (document.getElementsByTagName("html")[0].dir = "rtl")
