...
$dbfield = array('id','faculty_id','faculty_name','user_type','username','email','status'); // need iset based sa table columns
$dborig = array('faculty_id','faculty_name','user_type','username','email','status'); // tabulator  checking
