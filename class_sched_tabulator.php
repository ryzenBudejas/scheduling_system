...
$sched = "`parent_id` = '$session_sched' AND room != 'BREAK TIME'";
...
$dbfield = array('parent_id','subject','section','schedule_from','schedule_to','day','room','unit','name','course_title'); // need iset based sa table columns
$dborig = array('parent_id','subject','section','schedule_from','schedule_to','day','room','unit','name','course_title'); // tabulator  checking
