...
$sorters =array();
$orderby ="id DESC";
$sql_where="active = '0' AND user_type = 'Faculty'";
$sql_conds="";
$sql_where_array=array();
$to_encode=array();
$output="";

$dbfield = array('id','faculty_id','faculty_name','department','email','status'); // need iset based sa table columns
$dborig = array('name','faculty_id','department','email','status'); // tabulator  checking
