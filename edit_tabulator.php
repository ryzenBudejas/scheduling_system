...
$dbfield = array('id','faculty_id','course_code','course_title','section','from_time','to_time','day','teacher'); // need iset based sa table columns
$dborig = array('id','faculty_id','course_code','course_title','section','from_time','to_time','day','teacher'); // tabulator  checking
